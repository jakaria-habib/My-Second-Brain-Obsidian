...
```
## 2. already github a project ache, akhn code push korte chaile
```js
1. git init (optional)
2. git staus
3. git add .
...
6. git push -u origin main
```
## 3. My documentation on Git and Github
```js
1. git init
2. git config --list
...
```
## 6. how to install or pull project from github on laravel phpstorm
```js
...
```
## 7. BITM ar sir ra diyechen github niye
```js
